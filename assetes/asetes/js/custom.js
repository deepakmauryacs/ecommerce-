...
//   }
  ...
  $(document).on("ready", function() {
    owlcarousel_slider(); 
    //price_range ();
    responsive_dropdown(); sidebar_margin(); video_popup(); description_tab (); custom_tab (); scrolltop_arrow (); popup_dropdown (); countdown_clock(); option_drop(); popup_links(); location_page ();
  });
});
