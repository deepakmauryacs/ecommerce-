        ...
        <div class="col-xl-2 col-lg-3 mb-sm-30 col-xl-20per">
          <div class="sidebar-block">
            ...
            <div class="sidebar-box mb-40 mb-xs-15 d-none d-lg-block"> 
              <a href="#"> 
                <img src="<?php echo base_url(); ?>/assetes/asetes/images/left-banner.jpg" alt="Image"> 
              </a> 
            </div>
            <div class="sidebar-box sidebar-item"> <span class="opener plus"></span>
              ...
              <div class="sidebar-contant">
                <ul>
                  <li>
                    <div class="pro-media"> <a href="#"><img alt="Image" src="<?php echo base_url(); ?>/assetes/asetes/images/1.jpg"></a> </div>
        ...
        <div class="col-xl-10 col-lg-9 col-xl-80per">
          <div class="shorting mb-30">
            <div class="row">
              <div class="col-lg-6">
                <div class="view">
                  <div class="list-types grid"> <a href="#">
                    <div class="grid-icon list-types-icon"></div>
                    </a> 
                  </div>
                  <div class="list-types list active "> <a href="#">
              ...
              <div class="col-xl-6 col-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    ...
                    <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/1.jpg" alt="Image"> </a> </div>
                  </div>
                ...
                <div class="col-md-4 col-6 item-width mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="#"> <img src="<?php echo base_url().'uploads/product/'.$row->gallery_image; ?>" alt="Image"> </a>
                    ...
                    <div class="product-item-details">
                      ...
                      <div class="price-box"> <span class="price">₹<?php echo $row->price;?></span> </div>
                    </div>
                  </div>
                </div>
                 <?php
