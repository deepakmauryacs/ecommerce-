      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="row">
            <div class="col-lg-5 col-md-5 mb-xs-30">
              <div class="fotorama" data-nav="thumbs" data-allowfullscreen="native"> <a href="#"><img src="images/1.jpg" alt="Stylexpo"></a> <a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/2.jpg" alt="Stylexpo"></a> <a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/3.jpg" alt="Stylexpo"></a> <a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/4.jpg" alt="Stylexpo"></a> <a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/5.jpg" alt="Stylexpo"></a> <a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/6.jpg" alt="Stylexpo"></a> <a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/4.jpg" alt="Stylexpo"></a> <a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/5.jpg" alt="Stylexpo"></a> <a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/6.jpg" alt="Stylexpo"></a> </div>
            </div>
        ...
        <div class="col-lg-3">
          <div class="brand-logo-pro align-center mb-30">
            <img src="<?php echo base_url(); ?>/assetes/asetes/images/brand5.png" alt="Stylexpo">
          </div>
                    ...
                    <div class="items-Reviews">
                      <div class="comments-area">
                        ...
                        <ul class="comment-list mt-30">
                          <li>
                            <div class="comment-user"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/comment-user.jpg" alt="Stylexpo"> </div>
          ...
          <div class="row">
            <div class="owl-carousel pro-cat-slider">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="main-label sale-label"><span>Sale</span></div>
                  <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/11.jpg" alt="Stylexpo"> </a>
                    <div class="product-detail-inner">
                      <div class="detail-inner-left align-center">
                        <ul>
                          <li class="pro-cart-icon">
