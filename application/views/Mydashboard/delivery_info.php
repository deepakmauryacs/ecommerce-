   ...
   <section class="content">
      ...
      <div class="row justify-content-center">
         <div class="col-md-12 col-sm-12">
            <form action="<?php echo base_url('Admin/Delivery_info/update_delivery')?>" method="post" class="custom-validation" enctype="multipart/form-data" >
            <div class="box box-default">
               ...
               <div class="box-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-12">
                        <textarea class="form-control ckeditor" type="text" name="description"  id="example-text-input" placeholder="Name"  required> <?php  if(!empty($edit_data)) echo( $edit_data->description) ?> </textarea>
