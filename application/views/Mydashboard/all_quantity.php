<div class="content-wrapper">
 <!-- Content Header (Page header) -->
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         <a href="<?php  echo base_url('Admin/Color/all_quantity') ?>" type="button"  class="btn btn-block btn-primary" style="float: right;"><span style="font-size: 15px;color: white;">Add New Quantity</span></a>
      </ol>
   </section>
   <!-- Main content -->
