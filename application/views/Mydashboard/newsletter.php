   ...
   <section class="content">
      ...
      <div class="row justify-content-center">
         <div class="col-md-9 col-sm-12">
            <form action="<?php echo base_url('Admin/Newsletter/add_newsletter')?>" method="post"  enctype="multipart/form-data"  novalidate>
            <div class="box box-default">
               ...
               <div class="box-body">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-8">
                        <textarea type="text" class="form-control" name="news_content" placeholder="Content"></textarea>
                     </div>
                  </div>
