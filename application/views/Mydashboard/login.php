...
<!-- Web Fonts
========================= -->
<link rel='stylesheet' href='<?php echo base_url() ?>assetes/login/login/css/font_family.css' type='text/css'>

<!-- Stylesheet
========================= -->
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assetes/login/login/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assetes/login/login/css/all.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assetes/login/login/css/stylesheet.css" />
<!-- Colors Css -->
    ...
    <div class="row no-gutters min-vh-100 py-5"> 
      ...
      <div class="col-lg-7 shadow-lg">
        <div class="hero-wrap d-flex align-items-center rounded-lg rounded-right-0 h-100">
          ...
          <div class="hero-bg hero-bg-scroll" style="background-image:url('<?php echo base_url() ?>assetes/asetes/images/swarnlogoo-removebg-preview (1).png');"></div>
          <div class="hero-content mx-auto w-100 h-100 d-flex flex-column">
            <div class="row no-gutters">
              <div class="col-10 col-lg-10 mx-auto">
                <div class="logo mt-5 mb-5 mb-lg-0"> <a href="#" title="logo"><img src="<?php echo base_url() ?>assetes/asetes/images/swarnlogoo-removebg-preview (1).png"  style="height: 100px;" alt="Logo"></a> </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-11 col-lg-10 mx-auto">
              <h3 class="text-white text-center mb-4">Sign In</h3>
                ...
                <?php endif; ?>
              <form id="loginForm" action="<?php echo base_url() ?>Login/adminlogin" class="form-dark" method="post">
...
<!-- Script --> 
<script src="<?php echo base_url() ?>assetes/login/login/js/jquery.min.js"></script> 
<script src="<?php echo base_url() ?>assetes/login/login/js/bootstrap.bundle.min.js"></script> 
<!-- Style Switcher --> 
<script src="<?php echo base_url() ?>assetes/login/login/js/switcher.min.js"></script> 
<script src="<?php echo base_url() ?>assetes/login/login/js/theme.js"></script>
</body>
</html>