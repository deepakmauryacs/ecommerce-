   ...
   <section class="content">
      ...
      <div class="row justify-content-center">
         <div class="col-md-9 col-sm-12">
            <form action="<?php echo base_url('Admin/Term/update_term_condition')?>" method="post" class="custom-validation" enctype="multipart/form-data" >
            <div class="box box-default">
               <div class="box-header with-border">
                  <h3 class="box-title">Term & Condition Information</h3>
               ...
               <div class="box-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <input class="form-control" type="text" name="description" value="<?php if(!empty($edit_data))  echo($edit_data->description)?>"  id="example-text-input" placeholder="Name"  required>
