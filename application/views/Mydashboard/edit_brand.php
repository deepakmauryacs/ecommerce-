   ...
   <section class="content">
      ...
      <div class="row justify-content-center">
         <div class="col-md-9 col-sm-12">
            <form action="<?php echo base_url('Admin/Brand/update_brand')?>" method="post" class="custom-validation" enctype="multipart/form-data" >
            <div class="box box-default">
               ...
               <div class="box-body">
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <input class="form-control" type="text" name="brand_name" value="<?php if(!empty($edit_data))  echo($edit_data->brand_name)?>"  id="example-text-input" placeholder="Name"  required>
