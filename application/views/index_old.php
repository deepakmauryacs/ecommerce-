    ...
    <section class="banner-mobile">
      <div class="banner">
        <div class="main-banner owl-carousel">
          <div class="item">
            <div class="banner-1"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/banner1.jpg" alt="Stylexpo">
          ...
          <div class="item">
            <div class="banner-3"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/banner3.jpg" alt="Stylexpo">
              <div class="banner-detail">
                <div class="container">
                  <div class="row">
                    <div class="col-lg-5 col-md-4 col-4"></div>
        ...
        <div class="col-xl-2 col-lg-3 col-xl-20per mt-30 left-side float-none-sm ">
          <div class="sidebar-block open1">
            ...
            <div class="sidebar-box sub-banner left-banner  mb-30 mb-sm-15 d-none d-lg-block"> 
              <a href="#"> 
                <img src="<?php echo base_url(); ?>/assetes/asetes/images/left-banner.jpg" alt="Beaox"> 
              </a> 
            </div>
                    ...
                    <div class="item client-detail">
                      <div class="quote right-side">
                        <div class="quote1-img">
                          <img src="<?php echo base_url(); ?>/assetes/asetes/images/quote1.png" alt="Beaox">
                        </div>
                        ...
                        <div class="quote2-img">
                          <img src="<?php echo base_url(); ?>/assetes/asetes/images/quote2.png" alt="Beaox">
                        </div>
                      </div>
                      <div class="client-img left-side ">
                        <h4 class="sub-title client-title">- Joseph deboungawer - </h4>
                        <img alt="Beaox" src="<?php echo base_url(); ?>/assetes/asetes/images/testimonial_img1.jpg"> 
                      </div>
                    </div>
                    <div class="item client-detail">
                      <div class="quote right-side">
                      ...
                      <div class="client-img left-side ">
                        <h4 class="sub-title client-title">- Joseph deboungawer - </h4>
                        <img alt="Beaox" src="<?php echo base_url(); ?>/assetes/asetes/images/testimonial_img2.jpg"> 
                      </div>
                    </div>
                    <div class="item client-detail">
                      <div class="quote right-side">
                      ...
                      <div class="client-img left-side ">
                        <h4 class="sub-title client-title">- Joseph deboungawer - </h4>
                        <img alt="Beaox" src="<?php echo base_url(); ?>/assetes/asetes/images/testimonial_img3.jpg"> 
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div id="blog"  class="owl-carousel">
                      ...
                      <div class="blog-item">
                        <div class="">
                          <div class="blog-media"> 
                            <img src="<?php echo base_url(); ?>/assetes/asetes/images/blog_img1.jpg" alt="Beaox">
                    ...
                    <div class="item">
                      <div class="blog-item">
                        <div class="">
                          <div class="blog-media"> 
                            <img src="<?php echo base_url(); ?>/assetes/asetes/images/blog_img2.jpg" alt="Beaox">
                            <div class="blog-effect"></div>
                            <a href="single-blog.html" title="Click For Read More" class="read">&nbsp;</a>
                            <div class="effect"></div>  
                          </div>
                    ...
                    <div class="item">
                      <div class="blog-item">
                        <div class="">
                          <div class="blog-media"> 
                            <img src="<?php echo base_url(); ?>/assetes/asetes/images/blog_img3.jpg" alt="Beaox">
                            <div class="blog-effect"></div>
                            <a href="single-blog.html" title="Click For Read More" class="read">&nbsp;</a>
                            <div class="effect"></div>  
                          </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="sub-banner sub-banner1" >
                    <img alt="Stylexpo" src="<?php echo base_url(); ?>/assetes/asetes/images/sub-banner1.jpg">
                ...
                <div class="col-md-6 mt-xs-30">
                  <div class="">
                    <div class="sub-banner sub-banner2">
                      <img alt="Stylexpo" src="<?php echo base_url(); ?>/assetes/asetes/images/sub-banner2.jpg">
                      <div class="sub-banner-detail">
                  ...
                  <div class="owl-carousel pro-cat-slider ">
                    <div class="item">
                      <div class="product-item">
                        ...
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/1.jpg" alt="Stylexpo"> </a>
                    ...
                    <div class="item">
                      <div class="product-item sold-out">
                        ...
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/2.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="main-label new-label"><span>New</span></div>
                        <div class="main-label sale-label"><span>Sale</span></div>
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/3.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/4.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="main-label sale-label"><span>Sale</span></div>
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/8.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/6.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="main-label new-label"><span>New</span></div>
                        <div class="main-label sale-label"><span>Sale</span></div>
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/13.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/12.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/16.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/10.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                ...
                <div id="top-cat-pro" class="owl-carousel sell-pro align-center">
                  <div class="item ">
                    <div class="item-inner">
                      <img src="<?php echo base_url(); ?>/assetes/asetes/images/cate_1.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <div>Women jackets</div>
                        <a class="btn btn-white" href="shop.html">View Products</a>
                      </div>
                    </div>
                  </div>
                  <div class="item ">
                    <div class="item-inner">
                      <img src="<?php echo base_url(); ?>/assetes/asetes/images/cate_2.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <div>cosmetics</div>
                        <a class="btn btn-white" href="shop.html">View Products</a>
                      </div>
                  ...
                  <div class="item ">
                    <div class="item-inner">
                      <img src="<?php echo base_url(); ?>/assetes/asetes/images/cate_3.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <div>lingerie</div>
                        <a class="btn btn-white" href="shop.html">View Products</a>
                      </div>
                  ...
                  <div class="item ">
                    <div class="item-inner">
                      <img src="<?php echo base_url(); ?>/assetes/asetes/images/cate_4.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <div>Men’s shoes</div>
                        <a class="btn btn-white" href="shop.html">View Products</a>
                      </div>
                  ...
                  <div class="item ">
                    <div class="item-inner">
                      <img src="<?php echo base_url(); ?>/assetes/asetes/images/cate_5.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <div>kid's wear</div>
                        <a class="btn btn-white" href="shop.html">View Products</a>
                      </div>
                  ...
                  <div class="item ">
                    <div class="item-inner">
                      <img src="<?php echo base_url(); ?>/assetes/asetes/images/cate_6.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <div>sunglasses</div>
                        <a class="btn btn-white" href="shop.html">View Products</a>
                      </div>
                  ...
                  <div class="item ">
                    <div class="item-inner">
                      <img src="<?php echo base_url(); ?>/assetes/asetes/images/cate_7.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <div>Men’s shirt</div>
                        <a class="btn btn-white" href="shop.html">View Products</a>
                      </div>
                  ...
                  <div class="item ">
                    <div class="item-inner">
                      <img src="<?php echo base_url(); ?>/assetes/asetes/images/cate_8.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                  ...
                  <div class="item ">
                    <div class="item-inner">
                      <img src="<?php echo base_url(); ?>/assetes/asetes/images/cate_9.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <div>watches</div>
                        <a class="btn btn-white" href="shop.html">View Products</a>
                      </div>
                  ...
                  <div class="item ">
                    <div class="item-inner">
                      <img src="<?php echo base_url(); ?>/assetes/asetes/images/cate_10.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <div>Women t-shirt</div>
                        <a class="btn btn-white" href="shop.html">View Products</a>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row m-0">
              <div class="col-lg-6 p-0">
                <div class="sub-banner small-banner small-banner1">
                  <a href="#">
                    <img src="<?php echo base_url(); ?>/assetes/asetes/images/small-banner1.jpg" alt="Stylexpo">
                  </a>
                </div>
              </div>
              <div class="col-lg-6 p-0 mt-sm-30">
                <div class="sub-banner small-banner small-banner2">
                  <a href="#">
                    <img src="<?php echo base_url(); ?>/assetes/asetes/images/small-banner2.jpg" alt="Stylexpo">
                  </a>
                </div>
              </div>
            </div>
                ...
                <div class="row">
                  <div class="owl-carousel best-seller-pro">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="main-label sale-label"><span>Sale</span></div>
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/5.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="main-label new-label"><span>New</span></div>
                        <div class="main-label sale-label"><span>Sale</span></div>
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/7.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="main-label sale-label"><span>Sale</span></div>
                        <div class="product-image"> <a href="product-page.html"> <img src="<?php echo base_url(); ?>/assetes/asetes/images/9.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
            ...
            <div class="row brand">
              <div class="col-md-12">
                <div id="brand-logo" class="owl-carousel align_center">
                  <div class="item"><a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/brand1.png" alt="Stylexpo"></a></div>
                  <div class="item"><a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/brand2.png" alt="Stylexpo"></a></div>
                  <div class="item"><a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/brand3.png" alt="Stylexpo"></a></div>
                  <div class="item"><a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/brand4.png" alt="Stylexpo"></a></div>
                  <div class="item"><a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/brand5.png" alt="Stylexpo"></a></div>
                  <div class="item"><a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/brand6.png" alt="Stylexpo"></a></div>
                  <div class="item"><a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/brand7.png" alt="Stylexpo"></a></div>
                  <div class="item"><a href="#"><img src="<?php echo base_url(); ?>/assetes/asetes/images/brand8.png" alt="Stylexpo"></a></div>
                </div>
              </div>
            </div>
          </div>
